...
type AuthClient interface {
	...
	AddPermissionToUser(ctx context.Context, in *UserPermissionParams, opts ...grpc.CallOption) (*emptypb.Empty, error)
	RemovePermissionFromUser(ctx context.Context, in *UserPermissionParams, opts ...grpc.CallOption) (*emptypb.Empty, error)
...
func (c *authClient) AddPermissionToUser(ctx context.Context, in *UserPermissionParams, opts ...grpc.CallOption) (*emptypb.Empty, error) {
	out := new(emptypb.Empty)
	err := c.cc.Invoke(ctx, "/auth.Auth/AddPermissionToUser", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *authClient) RemovePermissionFromUser(ctx context.Context, in *UserPermissionParams, opts ...grpc.CallOption) (*emptypb.Empty, error) {
	out := new(emptypb.Empty)
	err := c.cc.Invoke(ctx, "/auth.Auth/RemovePermissionFromUser", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type AuthServer interface {
	...
	AddPermissionToUser(context.Context, *UserPermissionParams) (*emptypb.Empty, error)
	RemovePermissionFromUser(context.Context, *UserPermissionParams) (*emptypb.Empty, error)
...
func (UnimplementedAuthServer) AddPermissionToUser(context.Context, *UserPermissionParams) (*emptypb.Empty, error) {
	return nil, status.Errorf(codes.Unimplemented, "method AddPermissionToUser not implemented")
}
func (UnimplementedAuthServer) RemovePermissionFromUser(context.Context, *UserPermissionParams) (*emptypb.Empty, error) {
...
func _Auth_AddPermissionToUser_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(UserPermissionParams)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(AuthServer).AddPermissionToUser(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/auth.Auth/AddPermissionToUser",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(AuthServer).AddPermissionToUser(ctx, req.(*UserPermissionParams))
	}
	return interceptor(ctx, in, info, handler)
}

func _Auth_RemovePermissionFromUser_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(UserPermissionParams)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(AuthServer).RemovePermissionFromUser(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/auth.Auth/RemovePermissionFromUser",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(AuthServer).RemovePermissionFromUser(ctx, req.(*UserPermissionParams))
	}
	return interceptor(ctx, in, info, handler)
}
...
var Auth_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		},
		{
			...
			Handler:    _Auth_AddPermissionToUser_Handler,
		},
		{
			MethodName: "RemovePermissionFromUser",
			Handler:    _Auth_RemovePermissionFromUser_Handler,
		},
		{
